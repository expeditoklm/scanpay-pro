...
class ProductsPageRequest {
  const ProductsPageRequest({required this.page, this.query = '', this.perPage = 20});
  ...
  @override
  bool operator ==(Object other) => other is ProductsPageRequest &&
      other.page == page && other.query == query && other.perPage == perPage;
...
final productsPageProvider = FutureProvider.family<ProductsPage, ProductsPageRequest>((ref, request) async {
  final auth = ref.watch(authProvider);
  if (auth == null) {
    return const ProductsPage(items: [], page: 1, perPage: 20, total: 0, totalPages: 1);
  }
